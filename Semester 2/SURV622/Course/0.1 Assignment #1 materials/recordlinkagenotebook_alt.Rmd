...
str2 = "hovels"
jarowinkler(str1, str2, W_1=1/3, W_2=1/3, W_3=1/3, r=0.5)
jarowinkler(str1, str2, W_1=1/3, W_2=1/3, W_3=1/3, r=1.0)
```
...
Now we will read in the data.  Note the two backward slashes or a single forward slash are required in Windows file paths.  You will need to replace the filepath with where you stored the file on your computer. Also, some code that adjusts the column names for compliance with the big data command requirements is included.
```{r cache = TRUE}
sdfilepath = "C:/Users/jameswag/University of Michigan Dropbox/James Wagner/Teaching/Fundamentals of Data Collection/2025 Winter/Homework/1 Assignment/surveydata.csv"
adfilepath = "C:/Users/jameswag/University of Michigan Dropbox/James Wagner/Teaching/Fundamentals of Data Collection/2025 Winter/Homework/1 Assignment/admindata.csv"
...
first <- RLBigDataLinkage(surveydata, admindata, identity1=identity_survey, identity2 = identity_admin, blockfld = c("city"), strcmp=TRUE, strcmpfun="jarowinkler", exclude=c(1:2, 5:13, 15:18))
```
...
```{r}
csvfilepath="C:/Users/jameswag/University of Michigan Dropbox/James Wagner/Teaching/Fundamentals of Data Collection/2025 Winter/Homework/1 Assignment/finalpairs.csv"
write.csv(finalpairs, file=csvfilepath)
```


## REFERENCE (Package Documentation)
Andreas Borg and Murat Sariyar (2010). RecordLinkage: Record Linkage in R.